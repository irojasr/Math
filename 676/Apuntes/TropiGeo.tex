...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{figs/fig1.1.png}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{figs/fig1.2.png}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth, trim= 0cm 0cm 0cm 0cm,clip]{figs/fig1.3.png}
\end{figure}
...
%%Based on 676-Intro
There are four ways to get to tropical geometry. 

\begin{enumerate}
    \item The first way is to do algebraic geometry over the tropical semifield: $(\bT,
    \oplus,\odot)=(\bR\cup\set{-\infty},\max,+)$. We can make polynomial 
    $$p(\un x)\:\left(\bR\cup\set{-\infty}\right)^n\to\bR\cup\set{-\infty}$$
    which gives us a piecewise linear function. 
    ...
    \begin{Def}
        A \term{tropical hypersurface} is the locus of non-linearity of $p$.
    \end{Def}
    \begin{Ex}
        Even polynomials of \emph{higher degree}, they will become linear. In this case $3\odot x^2=3+2x$ for example.
    \end{Ex}
