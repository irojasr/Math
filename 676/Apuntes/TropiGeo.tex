...
\begin{Ex}
   % For our example we calculate $H^\Trop_{1\xrightarrow{4}0}((4),(2,2))$. The automorphism group of this graph has size $4$, then multiplying the edge weights we get $4$. So we get $H=4+\dots$. The other $3$ covers are \red{DRAWING}, and we have the following contributions
