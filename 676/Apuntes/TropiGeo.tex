...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth, trim= 0,5cm 25cm 3cm 0.5cm,clip]{figs/fig11-(3,4,5)-VectorIntersections.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth, trim= 0,5cm 10cm 3cm 7cm,clip]{figs/fig11-(3,4,5)-VectorIntersections.pdf}
    \caption{Weighted Vector Intersections}
        \label{fig:11.4-WeightedVectorIntersection1}
\end{figure}

From this we deduce that intersection points should be weighted by multiplicity of the edges they belong to. We need to build theory in order to consider this idea.
