...
\textbf{Example:}
  ...
  \begin{align*}
    ...
    \end{pmatrix}
  \end{align*}
  With this, condition 2 is now met.\par However, condition 3 is still not met. The 1 in the second row has a 1 above it, and the one in the third row has a -2 and a 2. To get rid of them, we apply a \textbf{combination}.
  \begin{align*}
    \begin{pmatrix}
        1&0&1&-2&0\\ 0&0&1&2&\frac{-5}{2}\\ 0&0&0&1&-3\\
