...
\begin{ptcbr}
    \footnote{\textbf{Ian} and \textbf{Kelsey} helped me out with the verification of the algorithms.} The following are the possible words given our alphabet:
    \begin{enumerate}[i)]
        \begin{multicols*}{3}
            \item $\begin{pmatrix}
                1&1&2&3\\1&2&3&4
        ...
        \end{multicols*}
    \end{enumerate}
    After applying the algorithm we obtain the following tableaux
    \begin{enumerate}[i)]
        \begin{multicols*}{3}
            \item $\young(1123),\ \young(1123)$
            \item $\young(2,113),\ \young(3,124)$
            \item $\young(2,113),\ \young(4,123)$
            \item $\young(3,112),\ \young(4,123)$
            \item $\young(2,113),\ \young(2,134)$
            \item $\young(23,11),\ \young(24,13)$
            \item $\young(23,11),\ \young(34,12)$
            \item $\young(3,112),\ \young(2,134)$
            \item $\young(3,2,11),\ \young(4,2,13)$
            \item $\young(3,2,11),\ \young(3,2,14)$
            \item $\young(3,112),\ \young(3,124)$
            \item $\young(3,2,11),\ \young(4,3,12)$
        \end{multicols*}
    \end{enumerate}
...
\begin{Ej}[Exercise 5]
    What two-line array corresponds to the following pair of semi-standard Young tableaux
