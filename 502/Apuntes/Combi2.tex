...
%We can notice that $\vec v=\threebyone{1}{1}{1}$ is an eigenvector with eigenvalue 1 of all of these matrices. The eigenspace $\gen(\vec v)$ is fixed by all of these matrices. The orthogonal complement to $\gen(\vec v)$ is rotated about the normal axis when acted by this matrices, such plane is 
