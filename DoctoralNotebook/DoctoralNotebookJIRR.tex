...
\red{TO DO 5}
\begin{itemize}
    \item Read equivariant cohomology of $\bP^1$.
    \item Write down examples of E.C. for a point by torus and point by integers. 
    \item Polish chapter 4 on strata, products, psi and lambda classes.
...
\begin{Def}
    For a vector bundle $E\xrightarrow{\pi}V$ of rank $r>1$, the \term{Euler class} is 
