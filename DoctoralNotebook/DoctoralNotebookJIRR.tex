...
In order to obtain a generating function for \(C^{\ps}(g,d)\), we take the square of \(\cI(t)\) and divide by \(d\) to get

\begin{align*}
    \cI(t)^2/d    & =\sum_{g\geq 0} \frac1d\left(\sum_{\substack{g_1+g_2=g   \\ g_1,g_2\geq 0}}I_{g_1}I_{g_2}\right)t^{2g}\\
    \To\cI(t)^2/d & =\sum_{g\geq 0} C^{\ps}(g,d)t^{2g}                       \\
    \To\cC(t)     & =\frac{dt^2/4}{\sin^2\left(\frac{dt/2}{1-t^2/24}\right)}
\end{align*}

\red{Some coefficients are not matching up... It's the degrees of the \(d\)'s} The first few terms of this sum are

\begin{align*}
      & \frac{1}{d} + \frac{(d^{2}-1)t^{2}}{12d} + \frac{(12d^{4}+5)t^{4}}{2880d} \\
    + & \frac{d^{3}(10d^{2}+21)t^{6}}{60480}                                      \\
    + & \frac{d^{3}(84d^{4}+400d^{2}+315)t^{8}}{14515200}+\dots                   \\
\end{align*}

% \begin{multline*}
%     \frac{1}{d} + \frac{(d^{2}-1)t^{2}}{12d} + \frac{(12d^{4}+5)t^{4}}{2880d} + \frac{d^{3}(10d^{2}+21)t^{6}}{60480} \\
%     + \frac{d^{3}(84d^{4}+400d^{2}+315)t^{8}}{14515200} \\
%     + \frac{d^{3}(180d^{6}+1386d^{4}+2750d^{2}+1155)t^{10}}{958003200} \\
%     + \frac{d^{3}(243232d^{8}+2620800d^{6}+8828820d^{4}+10010000d^{2}+2627625)t^{12}}{41845579776000} \\
%     + \frac{d^{3}(17472d^{10}+243232d^{8}+1179360d^{6}+2354352d^{4}+1751750d^{2}+315315)t^{14}}{100429391462400} \\
%     + \frac{d^{3}(2083392d^{12}+35642880d^{10}+227421920d^{8}+668304000d^{6}+900539640d^{4}+476476000d^{2}+62537475)t^{16}}{409751917166592000} \\
%     + \frac{d^{3}(23863648d^{14}+484909488d^{12}+3851658720d^{10}+15123557680d^{8}+30554023500d^{6}+29942943030d^{4}+11882120250d^{2}+1188212025)t^{18}}{163491014949470208000} \\
%     + \frac{d^{3}(35670931968d^{16}+840000409600d^{14}+8001006552000d^{12}+39543696192000d^{10}+108133437412000d^{8}+161325244080000d^{6}+120769870221000d^{4}+37343806500000d^{2}+2940824761875)t^{20}}{8632325589332026982400000} \\
%     + \frac{d^{3}(275631713280d^{18}+7383882917376d^{16}+82110040038400d^{14}+490728401856000d^{12}+1705321898280000d^{10}+3481896684666400d^{8}+4019687331660000d^{6}+2380891727214000d^{4}+590498940281250d^{2}+37577205290625)t^{22}}{2382521862655639447142400000} \\
%     + \frac{d^{3}(33401082427392d^{20}+1003299436339200d^{18}+12766733564143104d^{16}+89664163721932800d^{14}+379578418835616000d^{12}+993179473558272000d^{10}+1584262991523212000d^{8}+1463166188724240000d^{6}+704148728323540500d^{4}+143294409508250000d^{2}+7522956499183125)t^{24}}{10406855496079833105118003200000} \\
%     + O(t^{25})
% \end{multline*}
