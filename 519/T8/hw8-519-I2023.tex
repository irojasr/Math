...
than $R$.
\end{Ej}
%https://math.stackexchange.com/questions/1453602/finding-a-suitable-radius-to-prove-fta-using-rouches-theorem
%https://planetmath.org/proofoffundamentaltheoremofalgebrarouchestheorem
\begin{ptcbr}
