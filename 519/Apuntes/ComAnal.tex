...
\begin{ptcbr}
    \begin{enumerate}[i)]
        ...
        \end{align*}
        As $z$ has complex modulus 1, any number of the form $z-1$ is on the ball $B(-1,1)$ except for the origin. Which means that their complex modulus is at most 2. \red{ARGUMENT FAILS}
    \end{enumerate}
\end{ptcbr}
\begin{Ej}
