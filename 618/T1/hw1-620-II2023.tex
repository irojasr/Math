...
\begin{enumerate}[i)]
    ...
    \item Is $\vec b_\la=\dl(x-\la)$ for $\la\in\bonj{0,1}$ an uncountable basis? \red{rewrite}
\end{enumerate}
\end{Ej}
...
\begin{ptcbr}
    \begin{enumerate}[i)]
        ...
        \item The delta functions are not a basis of $C^0$ as they are not continuous, moreover, no delta function belongs in $L^2$. \par %https://math.stackexchange.com/questions/1805184/the-dirac-delta-does-not-belong-in-l2
