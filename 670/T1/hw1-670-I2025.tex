...
%\begin{multicols}{2}
   ...
   \begin{enumerate}
	...
	\begin{align*}
		...
		&=(1-2)\frac{1}{\norm{\vec{x}}^{2n}}=\frac{-1}{\norm{\vec{x}}^{2n}}
	\end{align*}
	This doesn't mean that the sphere is non-orientable, but that my choice of atlas was a poor choice. I will revisit this problem in a bit. %check https://math.stackexchange.com/questions/66228/orientability-of-the-sphere
