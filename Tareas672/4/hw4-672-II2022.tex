...
\begin{ptcbr}
  \begin{enumerate}[i)]
    \itemsep=-0.4em
    \item \blu{I still need to think this one, it's giving me trouble. I thought about it on the real case and I can visualize it. I even tried using the stereographic projection with a computer program to look at it but I can't grasp it.}
...
\newpage
  \begin{Ej}
    ...
    \begin{enumerate}[i)]
      \itemsep=-0.4em
      \item $\bC[x,1/x,y]$ (this is, rational functions whose denominator is a polynomial in $x$.) \hint{See exercise 4.1.1 and the preceding paragraphs.}
