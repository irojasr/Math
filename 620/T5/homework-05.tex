...
\problem{Weak derivatives and membership in $W^{1,2}$}{20}{
...
Next, consider the function $u : \R^2 \rightarrow \R$ of two arguments,
\begin{align*}
...
the unit ball in $\R^2$ as the domain?
...
\problem{Boundedness of dual functionals}{20}{
The dual space $X'$ of a vector space $X$ is the set of all linear,
continuous functionals $\varphi: X \rightarrow \R$.
...
\problem{The dual space of $L^p$}{20}{
...
and that $\Omega\subset\R^d$ is a bounded domain.
...
\problem{The norm on the dual space of $L^p$}{20}{
...
\problem{Weak convergence}{20}{
% Dacorogna, example 1.19
...
\begin{align*}
  ...
  \end{cases}
\end{align*}
and let $\bar w$ be its periodic extension to all of $\R$.
...
start with \textit{any} bounded function $w:[0,1]\rightarrow \R$ and its
