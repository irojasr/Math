...
\begin{ptcbr}
    ...
    which is positive semi-definite. This is because the eigenvalues $0$ and $\frac{\mu}{(1+\xi^2)^{3/2}}$ are non-negative. We may guarantee that the function is convex.
    \end{enumerate}
\end{ptcbr}
...
\end{gather*}
so that gathering all this up we get a differential equation with conditions $u(0)=H$ and $u(L)=0$. \red{FINISH UNIQUENESS}
\end{ptcbr}
